...
class Setting(models.Model):
    ...
    logo = models.ImageField(upload_to='setting_image',blank=False, null=False)
    street = models.CharField(max_length=120, blank=False, null=False)
    ...
    email = models.EmailField(max_length=100, default='info@soprescom.net', blank=False, null=False)
